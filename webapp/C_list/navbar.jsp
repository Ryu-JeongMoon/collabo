    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="navbarColor02">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:18080/Hansol/C_list">공지사항 게시판</a>
                </li>
                <li class="nav-item">
                ...
                <c:choose>
                    <c:when test="${login != null }">
                        <li class="nav-item">
                            <a class="nav-link" href="C_list/controller?type=out" onclick="return confirm('로그아웃?');">${login}님 로그아웃</a>
                        </li>
                    </c:when>
                    <c:when test="${login == null }">
                        <li class="nav-item">
                            <a class="nav-link" href="C_list/login.jsp">로그인</a>
                        </li>
                    </c:when>
                </c:choose>
            </ul>

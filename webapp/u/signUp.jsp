        ...
        <table class="table table-hover" border="1">
            ...
            <tr class="table-active">
                ...
                <td>
                    <div class="form-group">
                        <fieldset>
                            <input class="form-control:focus" type="password" placeholder="비밀번호를 입력하세요" name="password"
                                   id="password">
            ...
            <tr class="table-active">
                ...
                <td>
                    <div class="form-group">
                        <fieldset>
                            <input class="form-control:focus" type="password" placeholder="비밀번호를 다시 한번 입력하세요"
            ...
            <tr class="table-active">
                ...
                <td>
                    <div class="form-group">
                        <fieldset>
                            <input class="form-control:focus" type="email" placeholder="이메일을 입력하세요" name="email"
                                   id="email">
            ...
            <tr class="table-active">
                ...
                <td>
                    <div class="form-group">
                        <fieldset>
                            <input class="form-control:focus" type="text" placeholder="핸드폰 번호를 입력하세요( - 제외)"
                                   name="phone" id="phone">

    ...
    <form name="writeForm" method="post">
        <table class="table table-hover" border="1">
            ...
            <tr class="table-active">
                <td colspan="2">
                    <div align="center">
                        <button class="btn btn-outline-primary" type="button" onclick="send_go2(this.form);">로그인
                        </button>
                        <button class="btn btn-outline-primary" type="button" onclick="send_go1(this.form)">회원가입
                        </button>
                    </div>
                </td>
            </tr>

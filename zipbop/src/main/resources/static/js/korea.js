...
function drawMap(target) {
    ...
    d3.json('json/korea.json', function(json) {
        states
            ...
            .attr('onclick', function(d){
                return 'location.href="http://localhost:8080/' + d.properties.name_eng + '"';
            }) // TODO 이동할 곳 링크 걸기;
            .attr('id', function(d) {
    ...
    function onclickEvent(path) {
        location.href='http://localhost:8080/path?path='+String.valueOf(path);
    }
}
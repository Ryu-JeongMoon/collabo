...
<jsp:include page="navbar.jsp" flush="true"/>
	...
	<c:if test="${not empty boardList}">
		...
		<div><img class = "image" src = "getImg.do?no=${board.pimg_no }"></div>
		<br>
		<div class="progress">
		  <div class="progress-bar" role="progressbar" style="width: ${board. percent }%" aria-valuenow="${board. percent }" 
...
<form action="getFundingList.do" >
  ...
  <ul>
	<c:if test="${pageMaker.prev}">
		<li class="page"><a href="getFundingList.do?page=1">처음</a></li>
    ...
    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
    	...
    	<li class="page"><a href="getFundingList.do?page=${pageMaker.tempEndPage }">맨끝</a></li>
    </c:if> 
  </ul>
</div>
</div>

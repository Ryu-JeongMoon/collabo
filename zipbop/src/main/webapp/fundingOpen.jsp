...
<table class="center">
	<thead>
		...
		<tr>
			<th colspan="2">상품명</th>
			<td colspan="2"><input type="text" name="product_name" placeholder="상품명을 입력해주세요"></td>
		</tr>
	</thead>
	<tbody>
		<tr>
			<th colspan="2">사업자명</th>
			<td colspan="2"><input type="text" name="id"<%-- ${funding.id } readonly--%>></td>
		</tr>
		<tr>
			<th colspan="2">마감일</th>
			<td colspan="2"><input type="date" name="deadLine"></td>
		</tr>	
		<tr>
			<th colspan="2">목표금액</th>	
			<td colspan="2">
